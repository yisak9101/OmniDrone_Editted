...
def main(cfg):
    ...
    # policy.load_state_dict(torch.load("/home/mlic/Repo/OmniDrone_Editted/scripts_paper/checkpoint_23e7ff13.pt"))
    ...
    def evaluate(
        ...
        imageio.mimsave("/home/mlic/Repo/OmniDrone_Editted/video.mp4", frames, fps=0.5 / cfg.sim.dt)
        return info
    # evaluate()
